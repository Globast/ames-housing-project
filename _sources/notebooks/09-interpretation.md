...
| **Espacio habitable** | El coeficiente positivo y estadísticamente sólido indica que el tamaño interior tiene un efecto directo y significativo sobre el precio. Un incremento de **100 ft²** en el área habitable promedio eleva el valor estimado entre **$7,500 y $8,000**. Los intervalos estrechos sugieren alta precisión en la estimación. |
| **Área del garaje (capacidad de autos)** | El efecto estimado muestra que cada espacio adicional en el garaje se asocia con un incremento de **$12,000–$14,000** en el precio. La magnitud del coeficiente refleja su relevancia práctica y coincide con el comportamiento observado en los datos, donde las viviendas con mayor capacidad de estacionamiento alcanzan precios más altos. |
| **Tamaño del sótano** | La relación estimada es positiva y de menor magnitud que la del área habitable. Por cada **100 ft² adicionales**, el precio aumenta entre **$2,000 y $2,500**, lo que indica que el espacio subterráneo agrega valor, aunque en menor proporción que las áreas principales. |
